...
func setupTestDB() *sql.DB {
	db, err := sql.Open("mysql", "root:@tcp(localhost:3306)/golang_restful_api_test?tls=skip-verify&autocommit=true")
...
func TestGetCategoryFailed(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodGet, "http://localhost:3000/api/categories/203290", nil)
	request.Header.Add("X-API-Key", "RAHASIA")
...
func TestDeleteCategoryFailed(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodDelete, "http://localhost:3000/api/categories/34039", nil)
	request.Header.Add("X-API-Key", "RAHASIA")
...
func TestUnauthorized(t *testing.T) {
	...
	request := httptest.NewRequest(http.MethodGet, "http://localhost:3000/api/categories", nil)
	request.Header.Add("X-API-Key", "RAHASIA SALAH INI BRO")
